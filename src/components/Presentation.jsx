...
function Presentation() {
    return (
        <div className='presentation-container'>
            ...
            <h2 className='gradient-name big-font-presentation'>Front-End Developer.</h2>
            <h3 className='presentation-text'>Soy un Front-End developer en Argentina. Me encanta todo lo relacionado con frontend.
